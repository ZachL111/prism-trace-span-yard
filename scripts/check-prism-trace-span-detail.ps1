...
$repo = "prism-trace-span-yard"
$language = "Scala"
$category = "Observability"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/prism-trace-span-walkthrough.md")) {
