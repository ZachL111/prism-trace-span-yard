"""Regression checks for the prism-trace-span-yard casebook."""
...
from casebook.harness import assert_expected, prism_trace_span_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(prism_trace_span_yard_summary(), assert_expected())
